    ...
    <div class="about-page">
        ...
        <section class="about-section" style="align-items: center;">
            ...
            <div class="about-grid">
                ...
                <div class="about-card">
                    <h3>Pembersihan</h3>
                    <p>Mengurangi jumlah sampah plastik di lautan dengan mengumpulkan dan mengolah sampah tersebut
                        menjadi produk berkualitas tinggi.</p>
                </div>
                <div class="about-card">
                    <h3>Partnership</h3>
                    <p>Mengembangkan hubungan kolaboratif dengan berbagai pihak, termasuk pemerintah, organisasi
                        non-profit, dan komunitas lokal, untuk mencapai tujuan bersama.</p>
                </div>
            </div>
        </section>
