...
WebUI.setText(findTestObject('Page_Add Product  ReTide/input_Price'), '99999999998.99')

WebUI.click(findTestObject('Page_Add Product  ReTide/button_Create'))

WebUI.rightClick(findTestObject('Page_Add Product  ReTide/p_The price field must not be greater than 99999'))

WebUI.verifyElementNotPresent(findTestObject('Page_Add Product  ReTide/p_The price field must not be greater than 99999'), 
    0)
