...
WebUI.setText(findTestObject('Page_Add Product  ReTide/input_Price'), '0.00')

WebUI.click(findTestObject('Page_Add Product  ReTide/button_Create'))

WebUI.rightClick(findTestObject('Page_Admin Dashboard - Laravel/div_Product berhasil ditambahkan'))

WebUI.verifyElementNotVisible(findTestObject('Page_Admin Dashboard - Laravel/div_Product berhasil ditambahkan'), FailureHandling.STOP_ON_FAILURE)
