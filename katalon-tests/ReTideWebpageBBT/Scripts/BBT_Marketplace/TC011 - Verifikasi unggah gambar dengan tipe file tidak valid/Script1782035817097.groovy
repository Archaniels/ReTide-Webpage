...
WebUI.setText(findTestObject('Page_Add Product  ReTide/input_Name'), 'Test Item')
...
WebUI.setText(findTestObject('Page_Add Product  ReTide/input_Image'), 'C:\\Users\\sxpix\\Downloads\\New folder (19)\\test.txt')

WebUI.click(findTestObject('Page_Add Product  ReTide/button_Create'))

WebUI.rightClick(findTestObject('Page_Add Product  ReTide/p_The image path field must be an image'))

WebUI.verifyElementPresent(findTestObject('Page_Add Product  ReTide/p_The image path field must be an image'), 0)
