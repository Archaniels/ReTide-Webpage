...
WebUI.setText(findTestObject('Page_Add Product  ReTide/input_Price'), '0.02')
...
WebUI.verifyElementPresent(findTestObject('Page_Admin Dashboard - Laravel/div_Product berhasil ditambahkan'), 0)
