...
WebUI.setText(findTestObject('Page_Add Product  ReTide/input_Price'), '100000000000.00')
...
WebUI.verifyElementPresent(findTestObject('Page_Add Product  ReTide/p_The price field must not be greater than 99999'), 
    0)
