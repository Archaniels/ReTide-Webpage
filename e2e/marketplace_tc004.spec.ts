...
test.describe('Marketplace Feature - Unit Tests via Playwright (Frontend Validation)', () => {
    ...
    /**
     * TC004: Verify product creation with Price = Min+1 (BVA - Valid)
     */
    test('TC004 - Verify product creation with Price = 0.02 passes validation', async ({ page }) => {
        // Arrange
