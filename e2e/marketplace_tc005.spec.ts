...
test.describe('Marketplace Feature - Unit Tests via Playwright (Frontend Validation)', () => {
    ...
    /**
     * TC005: Verify product creation with Price = Max-1 (BVA - Valid)
     */
    test('TC005 - Verify product creation with Price = 9999.98 passes validation', async ({ page }) => {
        // Arrange
